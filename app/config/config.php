...
return array(
	'GET_REQUEST_URL' => array(
          ...
          'rates_by_date_base_and_codes' => 'http://api.fixer.io/{yyyy-mm-dd}?base={CURRENCY_CODE}&symbols={COMMA_SEP_CODES}',
...
'rates_by_date_base_and_codes' => 'https://api.fixer.io/{yyyy-mm-dd}?base={CURRENCY_CODE}&symbols={COMMA_SEP_CODES}',
